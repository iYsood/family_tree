...
(FamilyTree._defaultConfig = function (e) {
    ...
    (FamilyTree.templates.john.field_1 = "<text " + FamilyTree.attr.width + '="1000" style="font-size: 36px; font-weight: 600; font-family: \'taha-naskh\', sans-serif;" fill="#aeaeae" x="60" y="-20" text-anchor="middle">{val}</text>'),
