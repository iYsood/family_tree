const showInformation = function(content){
  $('#fetch_view_name_photo').html('');
  $('#fetch_view_content').html('');
  $('#viewTreeDetail').modal('show');

  $('#fetch_view_name_photo').html(`<img class="d-flex rounded-circle avatar-md" src="${content.img}" alt="${content.name}">
  <div class="media-body">
      <h3 class="tree_modal_name">${content.name}</h3>
  </div>`);
  ...
  const ident_lang = {
    ...
    daughter_info: 'أسماء البنات وأزواجهن',
  ...
  for (let key in content) {
    ...
    // console.log(key);
    if (key != 'title' && ident_lang[key] != undefined){
      $('#fetch_view_content').append(`<div class="form-group">
        <h3>${ident_lang[key]}</h3>
        <h4 class="form-text text-muted ms-1 pl-3">${content[key]}</h4>
      </div>`);
    }else if(key == 'title') {
      $('#fetch_view_content').append(`<div class="form-group">
        <h4 class="form-text text-muted ms-1 pl-3">${content[key]}</h4>
...
(FamilyTree._defaultConfig = function (e) {
    ...
    (FamilyTree._defaultConfig = function (e) {
        ...
        return (
            ...
            e && e.template
                ? ((t.tags.alive = { template: e.template + "_alive" }), (t.tags.died = { template: e.template + "_died" }))
                : ((t.tags.alive = { template: t.template + "_alive" }), (t.tags.died = { template: t.template + "_died" })),
            t
        );
    }),
    ...
    (FamilyTree.IT_IS_LONELY_HERE = '<g transform="translate(-100, 0)" style="cursor:pointer;"  ' + FamilyTree.attr.control_add + '="control-add"><text fill="#6bd6b9">{link}</text></g>'),
    (FamilyTree.RES = {}),
    ...
    (FamilyTree.MAX_NODES_MESS = "The trial has expired or 200 nodes limit was reached! <br /><a style='color: #6bd6b9;' target='_blank' href='https://balkan.app/FamilyTreeJS/Docs/Evaluation'>See more</a>"),
    (FamilyTree.OFFLINE_MESS = "The evaluation version requires internet connection! <br /><a style='color: #6bd6b9;' target='_blank' href='https://balkan.app/FamilyTreeJS/Docs/Evaluation'>See more</a>"),
            ...
            (this.obj = e),
                ...
                t.layout &&
                    ...
                    (this.layouts.innerHTML =
                        ...
                        '="normal" style="cursor: pointer;" width="110" height="100"><rect fill="#6bd6b9" x="35" y="0" width="50" height="27"></rect><rect fill="#aeaeae" x="7" y="41" width="50" height="27"></rect><rect fill="#aeaeae" x="63" y="41" width="50" height="27"></rect><line stroke="#000000" x1="60" x2="60" y1="27" y2="35" stroke-width="1"></line><line stroke="#000000" x1="32" x2="88" y1="35" y2="35" stroke-width="1"></line><line stroke="#000000" x1="32" x2="32" y1="35" y2="41" stroke-width="1"></line><line stroke="#000000" x1="88" x2="88" y1="35" y2="41" stroke-width="1"></line></svg><svg ' +
                        FamilyTree.attr.layout +
                        '="treeRightOffset" style="cursor: pointer;" width="110" height="100"><rect fill="#6bd6b9" x="35" y="0" width="50" height="27"></rect><rect fill="#aeaeae" x="40" y="41" width="50" height="27"></rect><rect fill="#aeaeae" x="40" y="73" width="50" height="27"></rect><line stroke="#000000" x1="60" x2="60" y1="27" y2="35" stroke-width="1"></line><line stroke="#000000" x1="60" x2="35" y1="35" y2="35" stroke-width="1"></line><line stroke="#000000" x1="35" x2="35" y1="35" y2="86" stroke-width="1"></line><line stroke="#000000" x1="35" x2="40" y1="86" y2="86" stroke-width="1"></line><line stroke="#000000" x1="35" x2="40" y1="54" y2="54" stroke-width="1"></line></svg><svg ' +
                        FamilyTree.attr.layout +
                        '="treeLeftOffset" style="cursor: pointer;" width="110" height="100"><rect fill="#6bd6b9" x="35" y="0" width="50" height="27"></rect><rect fill="#aeaeae" x="30" y="41" width="50" height="27"></rect><rect fill="#aeaeae" x="30" y="73" width="50" height="27"></rect><line stroke="#000000" x1="60" x2="60" y1="27" y2="35" stroke-width="1"></line><line stroke="#000000" x1="60" x2="85" y1="35" y2="35" stroke-width="1"></line><line stroke="#000000" x1="85" x2="85" y1="35" y2="86" stroke-width="1"></line><line stroke="#000000" x1="80" x2="85" y1="86" y2="86" stroke-width="1"></line><line stroke="#000000" x1="80" x2="85" y1="54" y2="54" stroke-width="1"></line></svg><svg ' +
                        FamilyTree.attr.layout +
                        '="mixed" style="cursor: pointer;" width="110" height="100"><rect fill="#6bd6b9" x="35" y="0" width="50" height="27"></rect><rect fill="#aeaeae" x="35" y="41" width="50" height="27"></rect><rect fill="#aeaeae" x="35" y="73" width="50" height="27"></rect><line stroke="#000000" x1="60" x2="60" y1="27" y2="41" stroke-width="1"></line><line stroke="#000000" x1="60" x2="60" y1="68" y2="73" stroke-width="1"></line></svg><svg ' +
                        FamilyTree.attr.layout +
                        '="tree" style="cursor: pointer;" width="110" height="100"><rect fill="#6bd6b9" x="35" y="0" width="50" height="27"></rect><rect fill="#aeaeae" x="7" y="41" width="50" height="27"></rect><rect fill="#aeaeae" x="7" y="73" width="50" height="27"></rect><rect fill="#aeaeae" x="63" y="41" width="50" height="27"></rect><rect fill="#aeaeae" x="63" y="73" width="50" height="27"></rect><line stroke="#000000" x1="60" x2="60" y1="27" y2="86" stroke-width="1"></line><line stroke="#000000" x1="57" x2="63" y1="54" y2="54" stroke-width="1"></line><line stroke="#000000" x1="57" x2="63" y1="86" y2="86" stroke-width="1"></line></svg>'),
    ...
    (FamilyTree.prototype._defaultExportOptions = function (e, t) {
        return (
            ...
            "pdf" == t && null == e.footer ? (e.footer = "الصفحة {current-page} من {total-pages}") : null == e.footer && (e.footer = ""),
    ...
    (FamilyTree.manager.__createNodes = function (e, t, i, r, a, n, l, o) {
        for (var s = i.nodes, d = [], c = [], m = {}, p = {}, h = 0; h < s.length; h++) {
            var f,
                u = s[h];
            (f = FamilyTree.STRING_TAGS ? (u.tags ? u.tags.split(",") : []) : Array.isArray(u.tags) ? u.tags.slice(0) : []), o.filterUI.addFilterTag(u) && f.push("filter"), u.life_status && f.push(u.life_status);
            ...
            (g.ftChildrenIds = []),
                ...
                FamilyTree.isNEU(u.life_status) || (g.life_status = u.life_status),
    ...
    (FamilyTree.templates.base = {
        defs: `
          <g transform="matrix(1,0,0,1,0,0)" id="dot"><circle class="bft-fill" cx="0" cy="0" r="5" stroke="#aeaeae" stroke-width="1"></circle></g>
          ...
          <g style="cursor: pointer;" id="base_tree_menu_close">
            <circle cx="12.5" cy="12.5" r="12" fill="#aeaeae"></circle>
        ...
        menuButton:
            '<div class="charts_menu" ' +
            FamilyTree.attr.control_export_menu +
            '=""><div class="d-inline-block sidemenu_btn"><i class="mdi mdi-backburger"></i></div></div>',
        padding: [50, 20, 35, 20],
    ...
    (FamilyTree.templates.john.defs = `
      <style>
        ...
        .{randId}.alive .bft-edit-form-header, .{randId}.alive .bft-img-button{
            background-color: #6bd6b9;
        }
        .{randId}.alive div.bft-img-button:hover{
          background-color: #aeaeae;
        }
        .{randId}.died .bft-edit-form-header, .{randId}.died .bft-img-button{
          background-color: #aeaeae;
        }
        .{randId}.died div.bft-img-button:hover{
          background-color: #6bd6b9;
        }
      </style>
      <clipPath id="john_img_0"><rect  x="6" y="6" rx="54" ry="54" width="108" height="108"></rect></clipPath>
        ...
        ${FamilyTree.gradientCircleForDefs("alive_circle", "#6bd6b9", 60, 5)}
        ${FamilyTree.gradientCircleForDefs("died_circle", "#aeaeae", 60, 5)}`
    ),
    (FamilyTree.templates.john.field_0 = "<text " + FamilyTree.attr.width + '="300" style="font-size: 36px; font-weight: 600; font-family: \'taha-naskh\', sans-serif;" fill="#333" x="60" y="170" text-anchor="middle">{val}</text>'),
    (FamilyTree.templates.john.field_1 = "<text " + FamilyTree.attr.width + '="1200" style="font-size: 24px; font-weight: 200; font-family: \'taha-naskh\', sans-serif;" fill="#666" x="60" y="-20" text-anchor="middle">{val}</text>'),
    ...
    (FamilyTree.templates.john.size = [120, 190]),
    (FamilyTree.templates.john_alive = Object.assign({}, FamilyTree.templates.john)),
    (FamilyTree.templates.john_alive.node += '<use x="0" y="0" xlink:href="#alive_circle" />'),
    (FamilyTree.templates.john_alive.ripple = { radius: 60, color: "#6bd6b9", rect: null }),
    (FamilyTree.templates.john_died = Object.assign({}, FamilyTree.templates.john)),
    (FamilyTree.templates.john_died.node += '<use x="0" y="0" xlink:href="#died_circle" />'),
    (FamilyTree.templates.john_died.ripple = { radius: 60, color: "#aeaeae", rect: null }),
    ...
    (FamilyTree.loading.show = function (e) {
        ...
        (t.id = "bft-loading"),
            (t.innerHTML =
                '<style>@-webkit-keyframes dot-keyframes {0% { opacity: .4; -webkit-transform: scale(1, 1);transform: scale(1, 1);}50% {opacity: 1;-webkit-transform: scale(1.2, 1.2);transform: scale(1.2, 1.2);}100% {opacity: .4;-webkit-transform: scale(1, 1);transform: scale(1, 1);}}@keyframes dot-keyframes {0% {opacity: .4;-webkit-transform: scale(1, 1);transform: scale(1, 1);}50% {opacity: 1;-webkit-transform: scale(1.2, 1.2);transform: scale(1.2, 1.2);}100% {opacity: .4;-webkit-transform: scale(1, 1);transform: scale(1, 1);}}.bft-loading-dots div {margin: 10px;}      .bft-dot-1 {background-color: #6bd6b9;}.bft-dot-2 {background-color: #aeaeae;}.bft-dot-3 {background-color: #FFCA28;}      .bft-loading-dots {text-align: center;width: 100%; position: absolute; top: 0;}.bft-loading-dots--dot {-webkit-animation: dot-keyframes 1.5s infinite ease-in-out;animation: dot-keyframes 1.5s infinite ease-in-out;        border-radius: 10px;display: inline-block;height: 10px;width: 10px;}.bft-loading-dots--dot:nth-child(2) {-webkit-animation-delay: .5s;animation-delay: .5s;}.bft-loading-dots--dot:nth-child(3) {-webkit-animation-delay: 1s;animation-delay: 1s;}</style><div class="bft-loading-dots"><div class="bft-loading-dots--dot bft-dot-1"></div><div class="bft-loading-dots--dot bft-dot-2"></div><div class="bft-loading-dots--dot bft-dot-3"></div></div>'),
    ...
    (FamilyTree.loc.ppdfCmdTitle = "معاينة الطباعة"),
    (FamilyTree.loc.ppdfSave = "طباعة"),
    (FamilyTree.loc.ppdfCancel = "اغلاق"),
    (FamilyTree.loc.ppdfFormat = "نوع الورق"),
    ...
    (FamilyTree.loc.ppdfLayout = "التخطيط"),
    (FamilyTree.loc.ppdfPortrait = "عمودي"),
    (FamilyTree.loc.ppdfLandscape = "أفقي"),
    (FamilyTree.loc.ppdfFittopagewidth = "تناسب عرض الصفحة"),
    (FamilyTree.loc.ppdfMargin = "الهامش"),
    (FamilyTree.loc.ppdfHeader = "الترويسة"),
    (FamilyTree.loc.ppdfFooter = "التذييل"),
    (FamilyTree.loc.ppdfScale = "القياس"),
    (FamilyTree.pdfPrevUI.show = function (e, t) {
        ...
        i.classList.add(e.config.mode),
            ...
            (i.innerHTML =
                ...
                '</h1><div class="mt-2"><button type="button" id="bft-prev-save" class="btn btn-outline-primary mr-5">' +
                FamilyTree.loc.ppdfSave +
                '</button>&nbsp;<button type="button" id="bft-prev-cancel" class="btn btn-outline-secondary">' +
                FamilyTree.loc.ppdfCancel +
                '</button></div><hr><div class="mt-3"><h4 for="bft-size">' +
                FamilyTree.loc.ppdfFormat +
                ': </h4><select id="bft-ppdf-size" class="form-control" id="bft-size"><option value="fit">' +
                ...
                '</option></select></div><div class="mt-3"><h4 for="bft-ppdf-layout">' +
                FamilyTree.loc.ppdfLayout +
                ': </h4><select id="bft-ppdf-layout" class="form-control" ><option value="false">' +
                FamilyTree.loc.ppdfPortrait +
                '</option><option value="true">' +
                FamilyTree.loc.ppdfLandscape +
                '</option></select></div><div class="mt-3"><h4 for="bft-scale">' +
                FamilyTree.loc.ppdfScale +
                ': </h4><select id="bft-ppdf-scale" class="form-control" id="bft-scale"><option value="fit">' +
                FamilyTree.loc.ppdfFittopagewidth +
                '</option><option value="10">10%</option><option value="20">20%</option><option value="30">30%</option><option value="40">40%</option><option value="50">50%</option><option value="60">60%</option><option value="70">70%</option><option value="80">80%</option><option value="90">90%</option><option value="100">100%</option><option value="110">110%</option><option value="120">120%</option><option value="130">130%</option><option value="140">140%</option><option value="150">150%</option><option value="160">160%</option><option value="170">170%</option><option value="180">180%</option><option value="190">190%</option><option value="200">200%</option></select></div><hr class="bt-3 mb-3"><div class="mt-3"><h4 for="bft-ppdf-header">' +
                FamilyTree.loc.ppdfHeader +
                ': </h4><input id="bft-ppdf-header" type="text" class="form-control"></div><div class="mt-3"><h4 for="bft-ppdf-footer">' +
                FamilyTree.loc.ppdfFooter +
                ': </h4><input id="bft-ppdf-footer" type="text" class="form-control"></div><div class="mt-3"><h4 for="bft-ppdf-margin">' +
                FamilyTree.loc.ppdfMargin +
                ': </h4><input id="bft-ppdf-margin" type="text" class="form-control"></div>');
    ...
    (FamilyTree.clinkTemplates.orange = {
        defs:
            '<marker id="arrowOrange" viewBox="0 0 10 10" refX="8" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse"><path fill="#aeaeae" d="M 0 0 L 10 5 L 0 10 z" /></marker><marker id="dotOrange" viewBox="0 0 10 10" refX="5" refY="5" markerWidth="5" markerHeight="5"> <circle cx="5" cy="5" r="5" fill="#aeaeae" /></marker>',
        link: '<path marker-start="url(#dotOrange)" marker-end="url(#arrowOrange)" stroke="#aeaeae" stroke-width="2" fill="none" d="{d}" />',
        label: '<text fill="#aeaeae" text-anchor="middle" x="{x}" y="{y}">{val}</text>',
    }),
    (FamilyTree.clinkTemplates.blue = {
        defs:
            '<marker id="arrowBlue" viewBox="0 0 10 10" refX="8" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse"><path fill="#6bd6b9" d="M 0 0 L 10 5 L 0 10 z" /></marker><marker id="dotBlue" viewBox="0 0 10 10" refX="5" refY="5" markerWidth="5" markerHeight="5"> <circle cx="5" cy="5" r="5" fill="#6bd6b9" /></marker>',
        link: '<path marker-start="url(#dotBlue)" marker-end="url(#arrowBlue)" stroke="#6bd6b9" stroke-width="2" fill="none" d="{d}" />',
        label: '<text fill="#6bd6b9"  text-anchor="middle" x="{x}" y="{y}">{val}</text>',
    }),
    ...
    (FamilyTree.slinkTemplates.orange = {
        defs:
            '<marker id="arrowSlinkOrange" viewBox="0 0 10 10" refX="8" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse"><path fill="#aeaeae" d="M 0 0 L 10 5 L 0 10 z" /></marker><marker id="dotSlinkOrange" viewBox="0 0 10 10" refX="5" refY="5" markerWidth="5" markerHeight="5"> <circle cx="5" cy="5" r="5" fill="#aeaeae" /></marker>',
        link: '<path stroke-dasharray="4, 2" marker-start="url(#dotSlinkOrange)" marker-end="url(#arrowSlinkOrange)" stroke-linejoin="round" stroke="#aeaeae" stroke-width="2" fill="none" d="{d}" />',
        label: '<text dominant-baseline="middle" fill="#aeaeae" alignment-baseline="middle" text-anchor="middle" x="{x}" y="{y}">{val}</text>',
        labelPosition: "middle",
    }),
    (FamilyTree.slinkTemplates.blue = {
        defs:
            '<marker id="arrowSlinkBlue" viewBox="0 0 10 10" refX="8" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse"><path fill="#6bd6b9" d="M 0 0 L 10 5 L 0 10 z" /></marker><marker id="dotSlinkBlue" viewBox="0 0 10 10" refX="5" refY="5" markerWidth="5" markerHeight="5"> <circle cx="5" cy="5" r="5" fill="#6bd6b9" /></marker>',
        link: '<path stroke-dasharray="4, 2" marker-start="url(#dotSlinkBlue)" marker-end="url(#arrowSlinkBlue)" stroke-linejoin="round" stroke="#6bd6b9" stroke-width="2" fill="none" d="{d}" />',
        label: '<text fill="#6bd6b9" text-anchor="middle" x="{x}" y="{y}">{val}</text>',
        labelPosition: "middle",
    }),
    ...
    FamilyTree.events.on("redraw", function (e, t) {
        if (e.config.miniMap) {
            ...
            var m = e.getViewBox()[0],
                ...
                h = e.getViewBox()[2],
                f = e.getViewBox()[3];
            (r.lineWidth = 0.5 / l), (r.strokeStyle = "#aeaeae"), r.strokeRect(m, p, h, f), (r.globalAlpha = 0.4), (r.fillStyle = FamilyTree.miniMap.selectorBackgroundColor), r.fillRect(m, p, h, f);
        }
    }),
    (FamilyTree.miniMap = {}),
    ...
    (FamilyTree.prototype.showTreeMenu = function (e) {
        ...
        if (n) m.push(n);
            ...
            var p = { id: "_ft_mother", templateName: "mother", _ft_method: "addParentNode", _ft_childId: e, _ft_type: "mid", _ft_data: { life_status: "died" } };
            (c.mid = p.id), a ? ((a.pids = [p.id]), (p.pids = [a.id]), (p._ft_data.pids = [a.id])) : (p.pids = ["_ft_father"]), m.push(p);
        }
        if (a) m.push(a);
        else {
            var h = { id: "_ft_father", templateName: "father", _ft_method: "addParentNode", _ft_childId: e, _ft_type: "fid", _ft_data: { life_status: "alive" } };
        ...
        if (("alive" == c.life_status ? ((f.templateName = "wife"), (f._ft_data.life_status = "died")) : "died" == c.life_status && ((f.templateName = "husband"), (f._ft_data.life_status = "alive")), c.pids.push(f.id), m.push(f), c.pids))
            for (s = 0; s < c.pids.length; s++) {
                if ((m.push({ id: "_ft_child_group_" + s, mid: e, fid: c.pids[s], tags: ["children-group"] }), "_ft_partner" == c.pids[s])) {
                    var u = {
                            ...
                            _ft_childData: { mid: t.id, fid: f.id, life_status: "alive" },
                        ...
                        y = {
                            ...
                            _ft_method: "addChildAndPartnerNodes",
                            _ft_childData: { mid: t.id, fid: f.id, life_status: "died" },
                            _ft_partnerData: { pids: [e] },
                            _ft_id: e,
                        };
                    "alive" == c.life_status && "died" == f._ft_data.life_status
                        ? ((u._ft_childData.mid = f.id),
                          (u._ft_childData.fid = c.id),
                          (u._ft_partnerData.life_status = f._ft_data.life_status),
                          (y._ft_childData.mid = f.id),
                          (y._ft_childData.fid = c.id),
                          (y._ft_partnerData.life_status = f._ft_data.life_status))
                        : "died" == c.life_status &&
                          "alive" == f._ft_data.life_status &&
                    ...
                    m.push({ id: "_ft_son_" + s, stpid: "_ft_child_group_" + s, templateName: "son", _ft_method: "addChildNode", _ft_data: { mid: e, fid: c.pids[s], life_status: "alive" } }),
                        m.push({ id: "_ft_daughter_" + s, stpid: "_ft_child_group_" + s, templateName: "daughter", _ft_method: "addChildNode", _ft_data: { mid: e, fid: c.pids[s], life_status: "died" } });
        ...
        for (g = 0; g < o.length; g++)
            if ((o[g].fid == c.id && FamilyTree.isNEU(o[g].mid)) || (o[g].mid == c.id && FamilyTree.isNEU(o[g].fid))) {
                ...
                "alive" == c.life_status ? ((b.templateName = "wife"), (b._ft_partnerData.life_status = "died")) : "died" == c.life_status && ((b.templateName = "husband"), (b._ft_partnerData.life_status = "alive")),
                    c.pids.push(b.id),
                    m.push(b),
    ...
    .bft-button.orange:hover {
        background-color: #f79632;
    }
    .bft-button.yellow:hover {
    ...
    .bft-dark .bft-button-icon:hover {
        background-color: #2d2d2d;
    }
    .bft-light .bft-button-icon:hover {
    ...
    .bft-light .bft-button.transparent {
        color: #6bd6b9;
    }
    .bft-light .bft-button.transparent:hover {
        color: #fff;
    }
    .bft-button-loading {
        background-color: transparent;
    ...
    .bft-button-loading .bft-loading-dots div {
        margin: 0 10px;
    }
    .bft-link-bft-button {
        position: absolute;
    ...
    [data-bft-input-disabled] .bft-link-bft-button {
        display: none;
    }
    [dir="rtl"] .bft-link-bft-button {
        left: 10px;
        right: unset;
    }
    .bft-img-button {
    ...
    .bft-dark [data-bft-input-disabled] .bft-checkbox-checkmark,
    .bft-dark [data-bft-input-disabled].bft-checkbox input:checked ~ .bft-checkbox-checkmark,
    .bft-light [data-bft-input-disabled] .bft-checkbox-checkmark,
    .bft-light [data-bft-input-disabled].bft-checkbox input:checked ~ .bft-checkbox-checkmark {
        background-color: #aeaeae !important;
    }
    [data-bft-input-disabled].bft-checkbox {
        cursor: default;
    }
    [dir="rtl"] .bft-checkbox-checkmark {
        right: 0;
    }
    [dir="rtl"] .bft-checkbox {
        padding-left: unset;
        padding-right: 35px;
    }
    .bft-dark .bft-checkbox-checkmark {
        background-color: #333;
        border: 1px solid #5b5b5b;
    }
    .bft-light .bft-checkbox-checkmark {
        background-color: #fff;
        border: 1px solid #c7c7c7;
    }
    .bft-dark .bft-checkbox:hover input ~ .bft-checkbox-checkmark {
        background-color: #3c3c3c;
    }
    .bft-light .bft-checkbox:hover input ~ .bft-checkbox-checkmark {
        background-color: #f8f9f9;
    }
    .bft-dark .bft-checkbox input:checked ~ .bft-checkbox-checkmark {
        background-color: #6bd6b9;
    }
    .bft-light .bft-checkbox input:checked ~ .bft-checkbox-checkmark {
        background-color: #6bd6b9;
    }
    .bft-checkbox-checkmark:after {
        content: "";
        position: absolute;
        display: none;
    }
    .bft-checkbox input:checked ~ .bft-checkbox-checkmark:after {
        display: block;
    }
    .bft-checkbox .bft-checkbox-checkmark:after {
        left: 9px;
        top: 5px;
        width: 5px;
        height: 10px;
    ...
    .bft-filter > div.bft-filter-menu {
        padding: 10px;
    }
    .bft-light .bft-filter > div.bft-filter-menu,
    .bft-light .filter-field-selected {
        background-color: #f8f9f9;
    }
    .bft-dark .bft-filter > div.bft-filter-menu,
    .bft-dark .filter-field-selected {
        background-color: #3c3c3c;
    }
    .bft-light .bft-filter > div {
        background-color: #eee;
    }
    .bft-dark .bft-filter > div {
        background-color: #333;
    }
    .bft-form-perspective {
    ...
    .bft-form {
        box-shadow: rgba(0, 0, 0, 0.2) 0 6px 6px 0, rgba(0, 0, 0, 0.19) 0 13px 20px 0;
        padding: 14px;
    ...
    .bft-light .bft-form .separator {
        border-bottom: 1px solid #c7c7c7;
    }
    .bft-dark .bft-form .separator {
    ...
    .bft-light .bft-form .bft-item.selected,
    .bft-light .bft-form .bft-item:hover {
        background-color: #0074e8;
        color: #fff;
    }
    .bft-dark .bft-form .bft-item.selected,
    .bft-dark .bft-form .bft-item:hover {
        background-color: #094771;
        color: #fff;
    }
    .bft-item.selected img,
    .bft-item:hover img {
        filter: invert(100%);
    }
    .bft-item.selected img {
    ...
    [data-bft-input-disabled].bft-input > input,
    [data-bft-input-disabled].bft-input > select {
        border-color: transparent !important;
    }
    .bft-light [data-bft-input-disabled] > input,
    .bft-light [data-bft-input-disabled] > select {
        background-color: #fff !important;
    }
    .bft-dark [data-bft-input-disabled] > input,
    .bft-dark [data-bft-input-disabled] > select {
        background-color: #252526 !important;
    }
    [data-bft-input-disabled] > select {
        appearance: none;
        padding-left: 8px;
    }
    .bft-input > label {
    ...
    .bft-input > label.focused,
    .bft-input > label.hasval {
        top: -1px;
    }
    .bft-input > input,
    .bft-input > select {
    ...
    .bft-dark .bft-input > input,
    .bft-dark .bft-input > select {
        color: #ccc;
        background-color: #333;
        border-color: #5b5b5b;
    }
    ...
    .bft-dark .bft-input > input:focus,
    .bft-dark .bft-input > select:focus {
        border-color: #6bd6b9;
        background-color: #3c3c3c;
    }
    .bft-dark .bft-input > input.bft-validation-error,
    .bft-dark .bft-input > select.bft-validation-error,
    .bft-light .bft-input > input.bft-validation-error,
    .bft-light .bft-input > select.bft-validation-error {
        border-color: #ca2a2a;
    }
    .bft-dark .bft-validation-error-message,
    .bft-light .bft-validation-error-message {
        color: #ca2a2a;
    }
    .bft-link {
        color: #6bd6b9;
    ...
    .bft-dark ::-webkit-scrollbar,
    .bft-light ::-webkit-scrollbar {
        width: 15px;
    }
    .bft-dark ::-webkit-scrollbar-track {
        background: #1e1e1e;
        border-left: 1px solid #333;
    }
    .bft-dark ::-webkit-scrollbar-thumb {
        background: #424242;
    }
    .bft-dark ::-webkit-scrollbar-thumb:hover {
        background: #4f4f4f;
    }
    .bft-dark ::-webkit-scrollbar-thumb:active {
        background: #5e5e5e;
    }
    .bft-light ::-webkit-scrollbar-track {
        background: #fff;
        border-left: 1px solid #ddd;
    }
    .bft-light ::-webkit-scrollbar-thumb {
        background: #c1c1c1;
    }
    .bft-light ::-webkit-scrollbar-thumb:hover {
        background: #929292;
    }
    .bft-light ::-webkit-scrollbar-thumb:active {
        background: #666;
    }
    .bft-edit-form {
        position: fixed;
    ...
    .export-service .bft-edit-form-header {
        border-radius: unset;
    }
    .bft-edit-form-title {
        color: #fff;
    ...
    .bft-family-menu {
        ...
        display: inline-block;
        position: absolute;
        font-family: 'taha-naskh', sans-serif;
        text-align: right;
        user-select: none;
        min-width: 270px;
        box-shadow: rgba(0, 0, 0, 0.2) 0 4px 8px 0, rgba(0, 0, 0, 0.19) 0 6px 20px 0;
        font: 18px/28px 'taha-naskh', sans-serif;
        border-radius: 10px;
    }
    .bft-family-menu > div:hover img {
        filter: invert(100%);
    }
    .bft-family-menu [data-item] {
        text-align: start;
        padding: 7px 10px;
    }
    ...
    .bft-dark .bft-family-menu [data-item]:hover {
        background-color: #094771 !important;
        color: #fff !important;
    }
    .bft-dark .bft-family-menu [data-item]:hover svg {
        filter: brightness(0) invert(1);
    }
    .bft-light .bft-family-menu [data-item] {
        background-color: #fff;
        color: #333;
        border-bottom: 1px solid #c7c7c7;
    }
    .bft-light .bft-family-menu [data-item]:hover {
        background-color: #0074e8 !important;
        color: #fff !important;
    }
    .bft-light .bft-family-menu [data-item]:hover svg {
        filter: brightness(0) invert(1);
    }
    .bft-family-menu [data-item] svg {
        vertical-align: middle;
    }
    .bft-family-menu [data-item]:first-child {
        border-top-left-radius: 7px;
        border-top-right-radius: 7px;
    }
    .bft-family-menu [data-item]:last-child {
    ...
    .bft-search table tr:first-child td:first-child {
        border-top-left-radius: 7px;
    }
    .bft-search table tr:first-child td:last-child {
        border-top-right-radius: 7px;
    }
    [dir="rtl"] .bft-search table tr:first-child td:first-child {
        border-top-left-radius: unset;
        border-top-right-radius: 7px;
    }
    [dir="rtl"] .bft-search table tr:first-child td:last-child {
        border-top-right-radius: unset;
        border-top-left-radius: 7px;
    }
    .bft-search table tr:last-child td:first-child {
        border-bottom-left-radius: 7px;
    }
    .bft-search table tr:last-child td:last-child {
        border-bottom-right-radius: 7px;
    }
    [dir="rtl"] .bft-search table tr:last-child td:first-child {
        border-bottom-left-radius: unset;
        border-bottom-right-radius: 7px;
    }
    [dir="rtl"] .bft-search table tr:last-child td:last-child {
        border-bottom-right-radius: unset;
        border-bottom-left-radius: 7px;
    }
    .bft-dark .bft-search table {
        background-color: #252526;
        color: #acacac;
    }
    .bft-search [data-search-item-id] {
        cursor: pointer;
    }
    .bft-search-photo {
    ...
    .bft-dark .bft-search [data-search-item-id] td {
        border-top: 1px solid #333;
    }
    .bft-dark .bft-search [data-search-item-id]:hover,
    .bft-dark .bft-search [data-selected="yes"] {
        background-color: #094771;
        color: #fff;
    }
    .bft-light .bft-search table {
        background-color: #fff;
        color: #333;
    }
    .bft-light .bft-search [data-search-item-id] td {
    ...
    .bft-search [data-search-item-id]:first-child td {
        border-top: unset;
    }
    .bft-ripple-container {
        position: absolute;
        top: 0;
        right: 0;
        bottom: 0;
    ...
    .bft-ripple-container span {
        transform: scale(0);
        border-radius: 100%;
        position: absolute;
        opacity: 0.75;
        background-color: #fff;
        animation: bft-ripple 1s;
    }
    @-moz-keyframes bft-ripple {
        to {
            opacity: 0;
            transform: scale(2);
        }
    }
    @-webkit-keyframes bft-ripple {
        to {
            opacity: 0;
            transform: scale(2);
        }
    }
    @-o-keyframes bft-ripple {
        to {
            opacity: 0;
            transform: scale(2);
        }
    }
    @keyframes bft-ripple {
        to {
            opacity: 0;
            transform: scale(2);
        }
    ...
    svg.bft-cursor-grab,
    svg.bft-cursor-grab text:hover {
        cursor: grab;
    }
    svg.bft-cursor-nodrop,
    svg.bft-cursor-nodrop text:hover {
        cursor: no-drop;
    }
    svg.bft-cursor-copy,
    svg.bft-cursor-copy text:hover {
        cursor: copy;
    }
    svg.bft-cursor-move,
    svg.bft-cursor-move text:hover {
        cursor: move;
    }
    #bft-close-btn:focus,
    #bft-close-btn:hover {
    ...
    #bft-id-select:focus {
        outline: 0.5px solid #aeaeae;
    }
    #bft-sampleDialog #title:hover {
        cursor: default;
        background: gray;
    }
    .bft-light {
    ...
    .bft-light input,
    .bft-light select {
        font: 16px Helvetica, "Segoe UI", Arial, sans-serif;
    }
    .bft-dark h1,
    .bft-light h1 {
        font-size: 30px;
    ...
    .bft-dark ::-webkit-calendar-picker-indicator {
        filter: invert(70%);
    }
    .bft-light ::-webkit-calendar-picker-indicator {
        filter: invert(50%);
    }
    ...
    .bft-light .bft-toolbar-container svg circle,
    .bft-light .bft-toolbar-container svg line,
    .bft-light .bft-toolbar-container svg path {
        stroke: #8c8c8c !important;
    }
    .bft-dark .bft-toolbar-container svg circle,
    .bft-dark .bft-toolbar-container svg line,
    .bft-dark .bft-toolbar-container svg path {
        stroke: #8c8c8c !important;
    }
    .bft-dark .bft-toolbar-container svg rect {
        fill: #252526 !important;
    }
    .bft-dark .bft-toolbar-container [data-tlbr="minus"] svg {
        border-left: 1px solid #5b5b5b !important;
        border-right: 1px solid #5b5b5b !important;
        border-bottom: 1px solid #5b5b5b !important;
    }
    .bft-dark .bft-toolbar-container [data-tlbr="plus"] svg {
        border-left: 1px solid #5b5b5b !important;
        border-right: 1px solid #5b5b5b !important;
        border-top: 1px solid #5b5b5b !important;
    }
    .bft-dark .bft-toolbar-container [data-tlbr] > svg {
